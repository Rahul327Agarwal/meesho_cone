        ...
        <div className='foot'>
            <div className='banner5'>
                ...
                <div className='banner5tbox'>
                    ...
                    <div className='logos'>
                        <a href='https://play.google.com/store/apps/details?id=com.meesho.supply&pid=pow_website&c=pow&pow_click_page_type=HP&pow_distinct_id=1803c191e5a119-01994abb2e7584-6b3e555b-e1000-1803c191e5b3b8' target='_blank' rel="noreferrer">
                            <img src="https://images.meesho.com/images/pow/playstore-icon-big.webp" alt="playstore" className='img_2' />
                        </a>
                        <a href='https://apps.apple.com/us/app/meesho/id1457958492' target='_blank' rel="noreferrer">
                            <img src="https://images.meesho.com/images/pow/appstore-icon-big.webp" alt="apple" className='img_2' />
                        </a>
                    </div>
                </div>
